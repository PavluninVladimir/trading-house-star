<template>
  ...
  <button @click="tog" data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
  ...
  <aside id="default-sidebar" ref="el" :class="{'-translate-x-full': isShow}" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0 " aria-label="Sidenav">
...
<!--            <tr v-for="person in data" :key="person">-->
...
import {useGetBotssLazyQuery, useGetBotssQuery} from "~/src/generated/operations";
import type {Query} from "~/src/generated/schema";

// const { data, error, pending, refresh } = await useAsyncGql({
//   "operation": 'bots',
//   "options": {
//     "transform": (data) => data.bots.map(function (bot) {
//       return bot.id;
//     }),
//   }
// })
...
// useQuery<BotRes>(query)
// const sss = useQuery(ss)
// console.log(sss)
// const res = use()
// console.log(res)
// const { data } = await useAsyncQuery(query, variables)
// const variables = { limit: 5 }
// const { result, loading, error } = useGetBotssLazyQuery()
// console.log(result)
...
const mouse = reactive(useSwipe(el, {
  // onSwipeStart() {
  //   console.log("onSwipe")
  //   isShow.value = false
  // },
